...
import { ThreadedFileDownload } from "./threadedViewer/threadedFileDownload";
...
export const ViewAddAttachmentsModal = ({files, mutate, id} : any ) => {
  ...
  return (
    ...
    >
      ...
      <DialogActions>
        ...
        <Button onClick={() => {setSubmitOpen(!submitOpen);}} color="primary">
          Add Files
        </Button>
      </DialogActions>
    </Dialog>
    <UploadAttachmentsModal open={submitOpen} setOpen={setSubmitOpen} mutate={mutate} id={id}/>
    </>
  );
}
